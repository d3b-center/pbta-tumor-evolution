...
# Run function
fname <- paste0(PBTA_plots_dir, "/", "Alteration_type_timepoints_barplots.pdf")
print(fname)
p <- create_stacked_barplot_variant(df = count_df, x = x_value, palette = palette, title = title)
pdf(file = fname, width = 6, height = 6)
print(p)
dev.off()
```
...
```{r plot-cg-id-PBTA, fig.width = 12, fig.height = 15, fig.fullwidth = TRUE}
# Define parameters for function
x_value <- PBTA_count_df$tumor_descriptor
...
# Run function
fname <- paste0(PBTA_plots_dir, "/", "Alteration_type_timepoints_cg_id_barplots.pdf")
print(fname)
p <- create_stacked_barplot_variant_cg_id(df = count_df, x = x_value, palette = palette, title = title, rows = rows)
pdf(file = fname, width = 12, height = 15)
print(p)
dev.off()
```
