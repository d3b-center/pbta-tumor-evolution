...
tmb_vaf_file <- file.path(results_dir, "tmb_vaf_pbta.tsv")
...
df_plot_samples <- print(length(unique(df_plot$Kids_First_Participant_ID)))
``` 
...
for (i in seq_along(tm)){
  ...
  # Save the plot
fname <- paste0(plots_dir, "/", tm[i], "-Alteration_type_cg_id_pbta.pdf")
