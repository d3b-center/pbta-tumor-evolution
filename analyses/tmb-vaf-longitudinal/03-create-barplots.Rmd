...
```{r create-stacked-barplot-filter-cancer-group-sum, fig.width = 10, fig.height = 6, fig.align='center', fig.show='hold', fig.cap="Number of mutations per patient & biospecimen"}
...
```{r create-barplot-sample, fig.width = 5, fig.height = 4, fig.fullwidth = TRUE, fig.show='hold', fig.align='center', out.width  =  "50%", fig.cap="Number of mutations per patient & biospecimen"}
