...
# Run function
fname <- paste0(PR_plots_dir, "/", sample[i], "_Alteration_type_timepoints_molecular_subtype_barplots_PR.pdf")
print(fname)
...
# Run function
fname <- paste0(PBTA_plots_dir, "/", sample[i], "_Alteration_type_timepoints_molecular_subtype_barplots_PBTA.pdf")
print(fname)
p <- create_stacked_barplot_variant_molecular_subtype(df = df_sub, x = x_value, palette = palette, title = title, rows = rows_value)
...
for (i in seq_along(sample)){
  ...
  # Run function
  fname <- paste0(PR_plots_dir, "/", sample[i], "_Alteration_type_timepoints_kids_barplots_PR.pdf")
  print(fname)
