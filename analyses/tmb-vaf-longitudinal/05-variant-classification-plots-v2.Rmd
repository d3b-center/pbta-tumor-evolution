...
```{r plot-molecular-subtype-PR, fig.width = 12, fig.height = 6, fig.fullwidth = TRUE}
PR_panel_df <- PR_count_df %>% 
...
```{r plot-cg-id-molecular-subtype-kids-PR, fig.width = 10, fig.height = 6, fig.fullwidth = TRUE}
cg_df <- PR_count_df %>%
