...
setwd("/Users/chronia/CHOP/GitHub/pbta-tumor-evolution/analyses/tumor-clone-inference/plots/clusters3_driver_genes2")
...
clone.colors <- c('lightblue', 'purple')
...
pp <- clonevol::plot.variant.clusters(x,
...
clone.colors <- c('grey', 'lightblue', 'purple')
...
for (i in 1:length(fishes)){
  ...
  fish = setCol(fish, c('lightblue', 'purple')) # f$clonevol.clone.colors
