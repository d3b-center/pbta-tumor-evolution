...
for (i in 1:length(data_dir) ) { 
  ...
  for (x in seq_along(sample_name) ) { 
   ...
   pp <- print(plot.variant.clusters(data_list[[i]],
   ...
   fname <- paste0(sample_name_plots_dir, "/", sample_name[x], "-variants.pairwise.plot.pdf")
   print(fname)
   ...
   for (i in 1:length(fishes)){
     ...
     print(fishPlot(fish,shape="spline", title.btm="Patient", cex.title=0.4,
