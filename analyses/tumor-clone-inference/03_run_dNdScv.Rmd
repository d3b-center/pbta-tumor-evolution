...
refdb_file <- file.path(input_dir, "RefCDS_human_GRCh38.p12_dNdScv.0.1.0.rda")
...
# Create Reference for gencode-v39

```{r}
## build Reference ranges for CDS in human coding genes
# https://rdrr.io/bioc/APAlyzer/man/REFCDS.html
...
#refdb_file = REFCDS(txdb, IDDB)
#extpath <- file.path(input_dir, "oncoprint-goi-lists-OpenPedCan-gencode-v39.csv")
#gencode.v39 <- readr::read_csv(extpath)
```
...
# We need to ensure that gene names match across genome references.
