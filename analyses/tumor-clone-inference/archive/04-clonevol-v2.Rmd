...
#sample.groups <- c("Deceased:BS_2T4EJ6KN", "Deceased:BS_537YFJ06", "Deceased:BS_C6T8F9K7", "Deceased:BS_GSXNQNRY", "Deceased:BS_M29BNE7Z" , "Deceased:BS_MRN9VDQ0", "Diagnosis:BS_W2QCHQ7E", "Recurrence:BS_EJP43CD9");
...
```{r eval=FALSE}
clone.colors <- c('#999793', '#8d4891', '#f8e356', '#fe9536', '#d7352e', "blue")
```
...
y = infer.clonal.models(variants = x,
    ...
    cancer.initiation.model='monoclonal', #'monoclonal' by default; 'polyclonal'
