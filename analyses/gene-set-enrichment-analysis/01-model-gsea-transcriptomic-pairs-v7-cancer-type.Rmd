...
for(i in 1:length(rna_library_list)){
  ...
  if(tumor_descriptor_n>=2){
    ...
    print(head(tumor_descriptor_model_results))
     ...
     tukey_fname <- paste0(results_dir, "/", "gsva_anova_", rna_library_list[i], "_", cgGFAC_list[x], "_tumor_descriptor.tsv")
    ...
    for(t in seq_along(td_models)){
      ...
      ###### barplots ###########
      name <- paste0(barplots_dir, "/", "gsva_tukey_", rna_library_list[i], "-", cgGFAC_list[x], "-", td_models[t], "-tumor_descriptor_barplot.pdf")
      print(name)
      ...
      ###### dot plots ###########
      dotplot_name <- paste0(dotplots_dir, "/", "gsva_tukey_", rna_library_list[i], "-", cgGFAC_list[x], "-", td_models[t], "-tumor_descriptor_dotplot.pdf")
      print(dotplot_name)
      ...
      volcano_name <- paste0(volcano_plots_dir, "/", "gsva_tukey_", rna_library_list[i], "-", cgGFAC_list[x], "-", td_models[t], "-tumor_descriptor_volcano_plot.pdf")
      print(volcano_name)
